...
export default function GroupingItems() {
    ...
    //
    fetch("http://192.168.10.26:8080/api/getSubGroupList/?mainGrId=" + mainId)
    ...
    //
    useEffect(() => {
        fetch("http://192.168.10.26:8080/api/appendSubGroupKala/?mainGrId=" + mainId + "&subKalaGroupId=" + subId)
            .then(response => response.json())
            .then((data) => {
                console.log(data)
    ...
    fetch("http://192.168.10.26:8080/api/getUnitsForUpdate/?Pcode=" + subId)
        .then(response => response.json())
        .then((data) => {
