    ...
    return (
        <div className="containerFluid px-0 mx-0">
            <div className="footer px-0 mx-0">
                <Link className="footerLink" to="/grouping"><span class="badge text-bg-danger notification">4</span><FontAwesomeIcon className="footerIcon text-light" icon={faListAlt} /></Link>
