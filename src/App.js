  ...
  return (
    <>
      <Routes>
        ...
        <Route path='/descKala' element={<DescKala  buyModal={byModal} showUpdateBuyModal={(goodSn,snOrderBYS)=>showUpdateBuyModal(goodSn,snOrderBYS)} showBuyModal={(goodSn,event)=>showBuyMdoal(goodSn,event)} buyOption={buyOption}/>} />
